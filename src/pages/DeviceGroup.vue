      ...
      <div style="width: 800px">
        ...
        <q-card class="q-ma-md">
          <q-card-section>
            ...
            <q-card class="q-ma-md">
              <q-list separator>
                <template v-for="device in devicegroup.devices">
                  <q-item :key="device.id" v-if="device.id !== $store.getters.getCurrentUser.id">
...
export default {
  ...
  methods: {
    gotoDevice (id) {
      this.$router.push({ path: '/home/devicegroups/mydevice/' + id })
    },
    getDevicegroup () {
